...
// =====================================================
// 图层信息导出：遍历所有图层收集名称、位置和尺寸
// Layers JSON export: Recursively collect layer name, position and size
// =====================================================
function getLayersInfo(layers, infoArray, indexRef) {
    for (var i = 0; i < layers.length; i++) {
        var lyr = layers[i];
        ...
        if (lyr.typename === "ArtLayer") {
            ...
            getLayersInfo(lyr.layers, infoArray, indexRef);
        }
    }
}
